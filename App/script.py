...
class Window(QWidget):
    ...
    def __init__(self):
        ...
        # setting geometry
        self.setGeometry(400, 400, 860, 850)
    ...
    def UiComponents(self):
        ...
        # User input
        i, ok = QInputDialog().getText(self, "QInputDialog().getInteger()",
                                 "Percentage:")
        b, g = QInputDialog().getText(self, "QInputDialog().getInteger()",
                            "N2")
        if ok:
        ...
        push_clear.clicked.connect(self.predict)
    ...
    def predict(self):
        self.label.setText("ML On the way !")
